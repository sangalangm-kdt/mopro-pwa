      ...
      {Array.from({ length: count }).map((_, index) => (
        ...
        >
          <div className="flex flex-col gap-2">
            <div className="w-36 h-4 bg-gray-200 dark:bg-zinc-700 rounded shimmer" />
            <div className="w-24 h-3 bg-gray-200 dark:bg-zinc-700 rounded shimmer" />
          </div>
          <div className="flex flex-col items-end gap-2">
            <div className="w-24 h-3 bg-gray-200 dark:bg-zinc-700 rounded shimmer" />
            <div className="w-12 h-12 bg-gray-200 dark:bg-zinc-700 rounded-full shimmer" />
          </div>
        </li>
      ))}
    </ul>
