...
export default function ProcessDropdown({
    ...
    return (
        <div className="space-y-1 relative" ref={dropdownRef}>
            ...
            {/* Dropdown menu */}
            {open && (
                <div className="absolute z-50 mt-1 w-full rounded-md shadow-lg bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 transition transform duration-200 ease-out scale-100 opacity-100">
