...
import { ScanSuccessData } from "@/types/scan";
...
export const MOCK_SCAN_DATA: Record<string, ScanSuccessData> = {
    "632152001": {
        ...
        orderNumber: "458R234",
        name: "Kobe Steel Kakogawa No.4 Reclaimer Renewal Work",
        updatedAt: "2023-11-12T20:04:00+08:00",
    ...
    "632152002": {
        ...
        orderNumber: "458R235",
        name: "Cement Plant Upgrade Phase II",
        updatedAt: "2023-12-01T14:32:00+08:00",
